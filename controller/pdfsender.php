...
function rellenarInfoPDF($db, $orderid, $type, $trans, $lang) {
    if($type == 1){
        ...
        ,billmobile FROM `invoice` WHERE orderid = ?";
    }else{
        ...
        ,email
        ,REPLACE(guidorder, '-', '') as guidorder
        ,billmobile FROM `order` WHERE id = ?";
    } 
    ...
    <html><head>
        ...
        <div class="invoice-box">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr class="heading">
                <td style="text-align: center;">'.$trans['pdf_heading_info1_2'].'</td>
                    <td style="text-align: center;">'.$trans['pdf_heading_info2_2'].'</td>
                    <td style="text-align: center;">'.$trans['pdf_heading_info3_2'].'</td>
                    <td>'.$trans['pdf_heading_info4_2'].'</td>
                </tr>
