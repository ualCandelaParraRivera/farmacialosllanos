...
function generarLinkTemporal($db, $guiduser, $email){
    ...
    $query = "SELECT * FROM resetpass WHERE guiduser = ?";
    $res = $db->prepare($query, array($guiduser));
    if($db->numRows($res)==0){
        $query = "INSERT INTO resetpass (guiduser, email, token, createdtime) VALUES(?,?,?,NOW());";
        $db->prepare($query, array($guiduser, $email, $token));
        $enlace = 'https://'.$_SERVER["HTTP_HOST"].$relativeurl.'/restorepassword?guiduser='.sha1($guiduser).'&token='.$token;
        return $enlace;
    }else{
        $query = "UPDATE resetpass SET guiduser=?, email=?, token=?, createdtime=NOW() WHERE guiduser = ?";
        $db->prepare($query, array($guiduser, $email, $token, $guiduser));
        $enlace = 'https://'.$_SERVER["HTTP_HOST"].$relativeurl.'/restorepassword?guiduser='.sha1($guiduser).'&token='.$token;
        return $enlace;
    }
}
...
function generarMensaje($link, $nombre){
    ...
    $link2 = str_replace("?","?<br>",str_replace("&", "<br>&", $link));
                   ...
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td valign="top" align="center" style="padding:0;Margin:0;width:600px"> 
                       <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                         <tr style="border-collapse:collapse"> 
                          <td style="padding:0;Margin:0;position:relative" align="center"><a href="#" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#C04A81;font-size:16px"><img class="adapt-img" src="'.imageToBase64("img/email/96831618321509776.png").' alt="Recover" title="Recover" width="600" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table></td> 
                   ...
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td valign="top" align="center" style="padding:0;Margin:0;width:520px"> 
                       <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                         <tr style="border-collapse:collapse"> 
                          <td class="es-m-txt-c" align="left" style="padding:0;Margin:0;padding-bottom:20px"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:\'trebuchet ms\', \'lucida grande\', \'lucida sans unicode\', \'lucida sans\', tahoma, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#666666;text-align:center">Hola, '.$nombre.'</h2></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:justify">Estás recibiendo este correo porque hemos encontrado una solicitud para restablecer tu contraseña. ¡No te preocupes, a todos nos ha pasado alguna vez! Para restablecerla solo pulsa el siguiente botón:</p></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td class="es-m-txt-c" align="center" style="padding:0;Margin:0"><span class="es-button-border" style="border-style:solid;border-color:transparent;background:#333333;border-width:0px;display:inline-block;border-radius:35px;width:auto"><a href="'.$link.'" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:16px;border-style:solid;border-color:#333333;border-width:15px 25px;display:inline-block;background:#333333;border-radius:35px;font-family:arial, \'helvetica neue\', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center">Restablecer contraseña</a></span></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td class="es-m-txt-c" style="padding:0;Margin:0;padding-top:25px;padding-bottom:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:24px;color:#666666;font-size:16px;text-align:justify">Si no funciona el botón puedes copiar y pegar en la barra de direcciones el siguiente enlace: <br><a href="'.$link.'">'.$link2.'</a></p></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-bottom:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:24px;color:#666666;font-size:16px">Este vínculo caducará dentro de 24 horas y solo podrás usarlo una vez.</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:24px;color:#666666;font-size:16px"><br>Si no has realizado esta solicitud simplemente ignora este correo. Tu contraseña no cambiará hasta que no crees una nueva.</p></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table></td> 
                   ...
                   <table class="es-left" cellspacing="0" cellpadding="0" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left"> 
                     <tr style="border-collapse:collapse"> 
                      <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:171px"> 
                       <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                         <tr style="border-collapse:collapse"> 
                          <td align="center" style="padding:0;Margin:0;padding-bottom:15px;font-size:0px"><a target="_blank" href="'.$webroot.'" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#C2C2C2;font-size:12px"><img src="'.imageToBase64("img/email/68601618315015577.png").'" alt="Logo Los Llanos" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" title="Logo Los Llanos" width="135"></a></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:18px;color:#C2C2C2;font-size:12px;text-align:center">info<a target="_blank" href="mailto:info@farmacialosllanos.org" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#C2C2C2;font-size:12px">@farmacialosllanos.org</a></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:18px;color:#C2C2C2;font-size:12px;text-align:center">© 2025&nbsp;Farmacia Los Llanos</p></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table> 
                         ...
                         <tr style="border-collapse:collapse"> 
                          <td align="left" style="padding:0;Margin:0;padding-bottom:15px;font-size:0"> 
                           <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                             <tr style="border-collapse:collapse"> 
                              <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><a target="_blank" href="https://www.facebook.com/FarmaciaLosLlanos/" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#C2C2C2;font-size:12px"><img title="Facebook" src="'.imageToBase64('img/email/facebook-circle-black.png').'" alt="Fb" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td> 
                              <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><a target="_blank" href="https://www.instagram.com/farmacialosllanosalmeria/" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#C2C2C2;font-size:12px"><img title="Instagram" src="'.imageToBase64('img/email/instagram-circle-black.png').'" alt="Inst" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td> 
                              
                             </tr> 
                           </table></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:18px;color:#C2C2C2;font-size:12px;text-align:justify">Recibió este correo electrónico porque visitó nuestro&nbsp;sitio o nos preguntó acerca del boletín. Puede darse de baja enviando un correo a info@farmacialosllanos.org o&nbsp;actualizando sus preferencias de suscripción.</p></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table> 
...
if(emailValidation($email)){   
    ...
    $query = "SELECT CONCAT(u.firstname,' ',u.middlename) as nombre, u.guiduser, u.email FROM user u WHERE u.email = ? AND isdeleted=0";
    $res = $db->prepare($query, array($email));

    if($res->num_rows > 0){
        $row = mysqli_fetch_array($res);
        $linkTemporal = generarLinkTemporal($db, $row['guiduser'], $row['email']);
        if($linkTemporal){
            $issended = enviarEmail($email, $linkTemporal, $row['nombre']);
            if($issended){
...
if (!empty($errors)) {
    $data['success'] = false;
    $data['errors']  = $errors;
    $data['message'] = $trans['control_resetpass_errormessage'];
}else{
    $data['success'] = true;
    $data['message'] = $trans['control_resetpass_successmessage'];
}
