        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <?php sectionbreadcrumb("Categorías", "|menucat|adminpcategories", $trans);?>
                    ...
                    <!-- ============================================================== -->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Listado de Categorías de Productos
                                    <div class="btn-group ml-auto">
                                        <a href="admineditpcat" class="btn btn-sm btn-dark">
                                            Nueva categoría
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr data-id="pcat-<?=$row['guidcategory']?>">
                                                    <td><?=$row['id']?></td>
                                                    <td><?=$row['nombre']?></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group ml-auto">
                                                            <a href="admineditpcat?guidcategory=<?=$row['guidcategory']?>" class="btn btn-sm btn-outline-light">
