    ...
    selectors.forEach((item, index) => {
        ...
        function multiSelects(){
            ...
            <div class="directorist-select__label">
                ...
                <input type="text" class='directorist-select__search ${ isSearch ? 'directorist-select__search--show' : 'directorist-select__search--hide' }' type='text' class='value' placeholder='Opciones de Filtro....' />
            </div>
            <div class="directorist-select__dropdown">            
                <div class="directorist-select__dropdown--inner"></div>
            </div>
