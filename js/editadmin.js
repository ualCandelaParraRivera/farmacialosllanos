            ...
            .done(function(data) {
                ...
                if (!data.success) {
                    ...
                    if (data.errors.intro) {
                        $('#intro').addClass('is-invalid');
                        $('#intro-group').append('<div class="help-block">' + data.errors.intro + '</div>');
                    }
                    if (data.errors.profile) {
                        $('#profile').addClass('is-invalid');
                        $('#profile-group').append('<div class="help-block">' + data.errors.profile + '</div>');
                    }
