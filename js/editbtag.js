$(document).ready(function() {
    ...
    $('form#datosbtag').submit(function(event) {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                if (!data.success) {
                    ...
                    $('form#datosbtag').append('<div class="mt-3 alert alert-danger">' + data.message + '</div>');

                } else {
                    if(data.redirect){
                        window.location.replace("adminbtags");
                    }else{
                        window.location.replace("admineditbtag?guidposttag="+data.message);
                    }
